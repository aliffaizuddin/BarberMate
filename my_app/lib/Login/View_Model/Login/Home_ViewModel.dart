...
class HomeViewModel extends Viewmodel {
  ...
  Future<void> editUser(String username,String type, String password, LoginModel toUpdate) async {
    LoginModel updated = await _loginServices.updateUser(username,type, password); 
